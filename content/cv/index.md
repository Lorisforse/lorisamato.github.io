...
- Gestione e troubleshooting di cluster Kubernetes multi-nodo in produzione, incluso rinnovo certificati TLS su control plane e gestione upgrade
- Amministrazione infrastruttura VMware e networking NSX-T: configurazione switch virtuali, firewall distribuiti, segmentazione di rete
- Gestione database PostgreSQL con replica, backup, manutenzione e analisi delle performance
- Amministrazione sistemi Red Hat / Oracle Linux in ambienti di produzione
- Gestione e verifica strategie di backup e restore con Veeam e Vinchin
...
- Creazione, configurazione e gestione di macchine virtuali Windows e Linux tramite VMware
- Gestione e configurazione dei backup con Veeam
- Implementazione soluzioni di Cybersecurity tramite antispam
...
- Individuazione, analisi e segnalazione di bug in componenti Java
...
**Homelab** — Raspberry Pi 4B con Home Assistant (Docker), automazioni smart home, integrazione dispositivi IoT, notifiche push su Android

**Nefta** — Startup personale su NFC smart tag per scheduling e automazione B2B

**Stampa 3D** — Progettazione e stampa di componenti custom
